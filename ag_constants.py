...
PRESETS = {
    "Einfaches Beispiel (klar getrennte Gruppen)": {
        ...
        "shape": "blobs", "linkage": "average", "target_k": 3, "seed": 1,
    },
    "Schwerer Fall (Chaining bei Single-Linkage)": {
        "n_points": 100, "k": 2, "spread": 0.225, "size_imbalance": 0.0, "bridge_strength": 1.0,
        "shape": "blobs", "linkage": "single", "target_k": 2, "seed": 2,
    },
    "Ungleiche Clustergrößen": {
        "n_points": 100, "k": 3, "spread": 0.2, "size_imbalance": 0.85, "bridge_strength": 0.0,
        "shape": "blobs", "linkage": "single", "target_k": 3, "seed": 3,
    },
    "Viele Gruppen (Dendrogramm wächst)": {
        "n_points": 120, "k": 6, "spread": 0.2, "size_imbalance": 0.0, "bridge_strength": 0.0,
        "shape": "blobs", "linkage": "average", "target_k": 6, "seed": 4,
    },
    "Nicht-konvexe Formen (Single-Linkage im Vorteil)": {
        "n_points": 120, "k": 2, "spread": 0.1, "size_imbalance": 0.0, "bridge_strength": 0.0,
        "shape": "moons", "linkage": "single", "target_k": 2, "seed": 5,
    },
}
